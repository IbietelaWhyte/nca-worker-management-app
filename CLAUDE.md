...
- **Eligibility is resolved through `_resolve_scope_groups`**, the same call generation uses, so "who may be on this rota" has one definition and the group also says which subteam to stamp. A head picks a person, not a slot.
