...
export const getWorkerAvailability = (workerId) =>
    apiClient.get(`/availability/workers/${workerId}`)
...
export const updateAvailability = (id, data) =>
    apiClient.patch(`/availability/${id}`, data)

export const deleteAvailability = (id) =>
    apiClient.delete(`/availability/${id}`)
...
export const getAvailableWorkersOnDay = (dayOfWeek) =>
    apiClient.get(`/availability/day/${dayOfWeek}`)