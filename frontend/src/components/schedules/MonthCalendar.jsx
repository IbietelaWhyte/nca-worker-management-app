 ...
 *
 * Hand-rolled with `grid grid-cols-7` rather than the shared `ui/calendar` component:
 * that file is v4-era shadcn source which this project's Tailwind v3 cannot compile, and
 * day cells need to hold several worker names anyway.
 */
