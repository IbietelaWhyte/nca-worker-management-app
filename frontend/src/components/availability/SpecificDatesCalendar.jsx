...
export default function SpecificDatesCalendar({ specificDates = [], onDateClick, loading }) {
        ...
        <div className="space-y-4">
            ...
            <div className="border rounded-lg p-4 inline-block">
                <DayPicker
                    ...
                    selected={[...availableDates, ...unavailableDates]}
                    onSelect={() => {}}
                    month={month}
                        ...
                        {[...specificDates]
                            ...
                            .map(record => (
                                ...
                                >
                                    ...
                                    <Badge
                                        variant={record.is_available ? 'success' : 'destructive'}
                                    >
